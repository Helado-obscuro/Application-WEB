                    ...
                    <div class="box">
                        <form method="post" action="checkout4.html">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                ...
                                <li class="active"><a href="checkout3.php"><i class="fa fa-money"></i><br>M&eacute;todo de pago</a>
                                </li>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="box payment-method">
                                            ...
                                            <p>Reinventa tu forma de comprar.</p>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box payment-method">
                                            ...
                                            <h4>Tarjetas de cr&eacute;dito/d&eacute;bito</h4>

                                            <p>Solamente VISa y Mastercard</p>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box payment-method">
                                            ...
                                            <h4>Tranferencia interbancaria</h4>

                                            <p>Dep&oacute;sito en efectivo a nuestra cuenta.</p>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="carrito.php" class="btn btn-default"><i class="fa fa-chevron-left"></i>Regresar a M&eacute;todo de entrega</a>
                                </div>
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary">Continuar con revisi&oacute;n de la orden<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>

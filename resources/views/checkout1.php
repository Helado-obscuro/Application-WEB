            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li>Verificaci&oacute;n - Direcci&oacute;n</li>
                    </ul>
                </div>
                    ...
                    <div class="box">
                        <form method="post" action="checkout2.html">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                <li class="active"><a href="checkout1.php"><i class="fa fa-map-marker"></i><br>Domicilio</a>
                                </li>
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary">Continuar con m&eacute;todo de entrega<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>

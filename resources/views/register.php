            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Nuevo registro / Iniciar sesión</li>
                    </ul>
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <p class="lead">¿A&uacute;n no te registras?</p>
                        <p>Con tu nuevo registro tendras acceso a nuestras ofertas, consultar nuestros productos, comprar en l&iacute;nea y revisar nuestro blog. ¡An&iacute;mate, te toma solo un min&uacute;to!</p>
                        <p class="text-muted">Si tienes alguna duda, <a href="contact.php"f>contáctanos</a> y con gusto te atenderemos las 24 horas del d&iacute;a, los 7 d&iacute;as de la semana.</p>
